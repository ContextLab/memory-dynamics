...
# place memory-dynamics repo and video-stims dirs in same enclosing dir

# to build and start for the first time:
#   with docker running:
#   from enclosing dir: `docker build -t latest -f memory-dynamics/Dockerfile .`
#   from eclosing dir: `docker run -it -p 22363:22363 --name MD memorydynamics`
