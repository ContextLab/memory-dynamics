...
@custom_code.route('/onfinish',methods=['POST'])
def onFinish():
	print(request.form['data'])
	call('node /Users/contextlab/Documents/github/cloud-speech/recognize -f ' + cwd + '/audio/' + request.form['data'] + '/' + ' -c ' + cwd + '/static/files/speech-context.csv',shell=True)
